    ...
    <fieldset class="main-form">
        ...
        <div class="row">
                ...
                <div class="form-group" data-service-order="1">
                    ...
                    <div class="col-sm-10">
                        <input type="text" value="<?=$customer['cust_id']; ?>" name="cust-id" class="form-control" id="cust-id" readonly placeholder="[ NEW CUSTOMER ]">
                    </div>
                </div><!--.form-group-->
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" value="<?=$customer['middlename']; ?>" name="middle-name" class="form-control" id="cust-middlename" placeholder="Enter Customer's Middle Name">
                    </div>
                </div><!--.form-group-->
                <div class="form-group" data-service-order="1">
                    <label for="first-name" class="col-sm-2 control-label">Last Name</label>
                    <div class="col-sm-10">
                        <input type="text" name="last-name" value="<?=$customer['lastname']; ?>" class="form-control" id="cust-lastname" placeholder="Enter Customer's Last Name">
                    </div>
                </div><!--.form-group-->
                <div class="form-group">
                    ...
                    <div class="col-sm-1">
                        <div class="radio">
                          <label><input type="radio" name="gender" class="cust-gender" id="gender-male" value="M" <?=$customer['gender_male'];?>>Male</label>
                        </div><!--.radio-->
                    </div>
                    <div class="col-sm-1">
                        <div class="radio">
                          <label><input type="radio" name="gender" class="cust-gender" id="gender-female" value="F" <?=$customer['gender_female'];?>>Female</label>
                        </div><!--.radio-->
                    </div>
                </div><!--.form-group-->
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <input name="bday" class="datepicker" type="text" class="form-control" id="cust-bday" value="<?=$customer['birthday'];?>" placeholder="Customer's Birthday">
                    </div>
                </div><!--.form-group-->
                <div class="form-group">
